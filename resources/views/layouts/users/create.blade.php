    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Registar novo utilizador</h5>
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                        ...
                        <select name="tipo" id="" class="form-control" >
                            @foreach ($tipoUtilizador as $tipoUtilizador)
                                <option name="tipo">{{ $tipoUtilizador->tipo }}</option>
                            @endforeach
